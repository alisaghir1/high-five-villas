    ...
    <section className="bg-customBg flex flex-col items-center justify-center gap-10 pb-20 pt-20">
      <div className="text-center mx-2">
        ...
        <p className="max-w-screen-sm text-customText2 md:block mx-auto font-mono">
          At High Five Properties, we proudly present our exclusive
          Climate-Controlled Sunken Garden a patented design that redefines
          luxury living. Experience unmatched comfort, beauty, and innovation in
